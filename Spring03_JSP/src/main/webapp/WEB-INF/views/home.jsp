...
<body>
	<div class="container">
		...
		<%--
			...
			3. /WEB-INF/view/fortune.jsp 페이지에서 오늘의 운세를 클라이언트에게 응답하도록 해보세요.
		 --%>
		<ul>
		...
		<h2>공지사항</h2>
		<ul>
			<!--tmp == List<String>  String type 타입으로    -->
			<c:forEach var="tmp" items="${requestScope.notice }"> <!-- requestScope. 는 생략 가능 -->
				<li>${tmp }</li>
			</c:forEach>
		</ul>
	</div>
