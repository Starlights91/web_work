...
public class MemberException extends RuntimeException {
	...
	//필드
	public final Reason reason; //#m final (상수)로 값이 한번 정해지면 변경 불가.
	//private int num;
	...
	// 예외 객체(MemberException)를 편리하게 만들어서 리턴해주는 편의 메소드
	...
	public static MemberException deleteFailed(int num) {
		return new MemberException(Reason.DELETE_FAILED, num+" 번 회원 삭제 실패");
	}
