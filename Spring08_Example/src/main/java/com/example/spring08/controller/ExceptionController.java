...
public class ExceptionController {
	...
	public String password(PasswordException pe, RedirectAttributes ra) { //#m 여기 RedirectAttributes ra 가지고 리다일렉트 사용. (Model 에 담는대신) 
		
		/*
		 * 	"exception" 이라는 키값으로 PasswordException 객체를 담는다.
		 * 	해당 정보는 리다일렉트 이동 Model 객체에 자동으로 담긴다
		 */
		ra.addFlashAttribute("exception", pe); //1회성 데이터
